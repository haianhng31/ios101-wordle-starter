...
class KeyboardCell: UICollectionViewCell {
  ...
  @objc private func didTapString() {
    // START YOUR CODE HERE
      ...
      // Forced unwrapping is a technique in Swift that allows you to access the value of an optional variable even if it is nil. This is done by using the ! operator after the variable name.
    // END YOUR CODE HERE
  }
}
